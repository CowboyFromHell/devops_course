import cherrypy
import json
cherrypy.config.update({'server.socket_host': '0.0.0.0', 'server.socket_port': 8080,'tools.json_in.force': False,})
...
class StringGenerator(object):
	...
	def index(self, **animal):
		if cherrypy.request.method == 'POST':
			for i in animal.keys():
				request_data = json.loads(i)
				try:
